...
#ifndef SQL_MySQL_Extractor_INCLUDED
#define SQL_MySQL_Extractor_INCLUDED
...
class MySQL_API Extractor: public Poco::SQL::AbstractExtractor
...
public:
	...
	virtual bool extract(std::size_t pos, Poco::SQL::BLOB& val);
		/// Extracts a BLOB.

	virtual bool extract(std::size_t pos, Poco::SQL::CLOB& val);
		/// Extracts a CLOB.

...
void Preparator::prepare(std::size_t pos, const Poco::SQL::BLOB&)
{
}


void Preparator::prepare(std::size_t pos, const Poco::SQL::CLOB&)
{
}


void Preparator::prepare(std::size_t pos, const Poco::SQL::Date&)
{
}


void Preparator::prepare(std::size_t pos, const Poco::SQL::Time&)
{
}

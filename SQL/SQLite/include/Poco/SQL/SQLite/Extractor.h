...
#ifndef SQL_SQLite_Extractor_INCLUDED
#define SQL_SQLite_Extractor_INCLUDED
...
class SQLite_API Extractor: public Poco::SQL::AbstractExtractor
...
private:
		...
		/// Utility function for extraction of Any and DynamicAny.
	{
		...
		default:
			throw Poco::SQL::UnknownTypeException("Unknown type during extraction");
		}
...
inline bool Extractor::extract(std::size_t pos, Poco::SQL::BLOB& val)
{
	return extractLOB<Poco::SQL::BLOB::ValueType>(pos, val);
}


inline bool Extractor::extract(std::size_t pos, Poco::SQL::CLOB& val)
{
	return extractLOB<Poco::SQL::CLOB::ValueType>(pos, val);
}

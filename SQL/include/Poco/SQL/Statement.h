...
#ifndef SQL_Statement_INCLUDED
#define SQL_Statement_INCLUDED
...
inline void Poco_SQL_API now(Statement& statement)
...
inline void Poco_SQL_API sync(Statement& statement)
...
inline void Poco_SQL_API async(Statement& statement)
...
inline void Poco_SQL_API deque(Statement& statement)
...
inline void Poco_SQL_API vector(Statement& statement)
...
inline void Poco_SQL_API list(Statement& statement)
...
inline void Poco_SQL_API reset(Statement& statement)
...
{
	template<>
	inline void swap<Poco::SQL::Statement>(Poco::SQL::Statement& s1,
		Poco::SQL::Statement& s2)

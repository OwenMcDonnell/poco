...
#ifndef SQL_Binding_INCLUDED
#define SQL_Binding_INCLUDED
...
template <>
inline AbstractBinding::Ptr use(Int64& t, const std::string& name)
	/// Convenience function for a more compact Binding creation.
{
...
template <>
inline AbstractBinding::Ptr use(UInt64& t, const std::string& name)
	/// Convenience function for a more compact Binding creation.
{
...
inline AbstractBinding::Ptr bind(T t)
	...
	/// This function differs from use() in its value copy semantics.
{
	return Poco::SQL::Keywords::bind(t, "");
}
